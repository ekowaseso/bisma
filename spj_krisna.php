  ...
  <script type="text/javascript">
    ...
    $.ajaxSetup({ cache: false });
      ...
      $(".buat").click(function(){
         if(validasi()){
            ...
            $.ajax({
                   url: 'data/krisnareport/create.php',
                   type: 'post',
                   data: {data:dataPost},
    ...
    Swal.fire({
      ...
      if (result.dismiss === Swal.DismissReason.timer) {
        Swal.fire({
          title: 'Cetak Laporan',
          html:'<a href="data/krisnareport/print.php?spj=kwi&id=' + id + '"  target="_blank"><button style="margin: 2px; width: 70%;"><b style="font-size: 17px;">Kwitansi</b></button></a><br>' +
                  '<a href="data/krisnareport/print.php?spj=po&id=' + id + '"  target="_blank"><button style="margin: 2px; width: 70%;"><b style="font-size: 17px;">Purchase Order</b></button></a><br> ' +
                  '<a href="data/krisnareport/print.php?spj=inv&id=' + id + '"  target="_blank"><button style="margin: 2px; width: 70%;"><b style="font-size: 17px;"> Invoice</button></b></a><br>' +
                  '<a href="data/krisnareport/print.php?spj=spk&id=' + id + '"  target="_blank"><button style="margin: 2px; width: 70%;"><b style="font-size: 17px;"> SPK</button></b></a><br>' +
                  '<a href="data/krisnareport/print.php?spj=bast&id=' + id + '"  target="_blank"><button style="margin: 2px; width: 70%;"><b style="font-size: 17px;"> BAST</button></b></a><br>'+
                  '',
