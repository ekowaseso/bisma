...
<head>
    ...
    <title>Laporan CV. DANANJAYA CIPTA PERSADA</title>
...
<body>
  ...
  <table class="table" id="data_table">
    ...
    <?php
      ...
      <tr>
        <td style="font-size: small;"><?php echo "<a target=_blank href=data/dananreport/cetak.php?id=".substr($filename, 0,-5).">".substr($filename, 0,-5)."</a>"?></td>
        ...
        $(".hapus").click(function(){
             ...
             Swal.fire({
                  ...
                  if (result.isConfirmed) {
                      ...
                      $.ajax({
                           url: 'data/dananreport/delete.php',
                           type: 'post',
                           data: {data:dataPost},
                           beforeSend: function(){
