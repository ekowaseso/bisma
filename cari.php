...
<head>
    ...
    <title>Laporan CV. Bisma Indonesia</title>
...
<body>
  ...
  <table class="table" id="data_table">
    ...
    <?php
      ...
      <tr>
        <td style="font-size: small;"><?php echo "<a target=_blank href=data/laporan/cetak.php?id=".substr($filename, 0,-5).">".substr($filename, 0,-5)."</a>"?></td>
