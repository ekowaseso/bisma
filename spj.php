  ...
  <script type="text/javascript">
    ...
    Swal.fire({
      ...
      if (result.dismiss === Swal.DismissReason.timer) {
        Swal.fire({
          title: 'Cetak Laporan',
          html:'<a href="data/laporan/print.php?spj=kwi&id=' + id + '"  target="_blank"><button style="margin: 2px; width: 70%;"><b style="font-size: 17px;">Kwitansi</b></button></a><br>' +
                  ...
                  '<a href="data/laporan/print.php?spj=bast&id=' + id + '"  target="_blank"><button style="margin: 2px; width: 70%;"><b style="font-size: 17px;"> BAST</button></b></a><br>'+
                  '',
