...
<body style="background-color: #e1d44c;">
  ...
  <h2 align="center" style="margin: 20px;">e-SPJ Danan Jaya</h2>
      ...
      <div class="col-md-6 offset-md-3">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <a href="spj_danan.php"><button style="margin-bottom: 5px;" type="button" class="btn btn-success btn-lg btn-block spj">Buat Laporan</button></a>
            
            <a href="cari_danan.php"><button style="margin-bottom: 5px;" type="button" class="btn btn-warning btn-lg btn-block cari">View Laporan</button></a>
